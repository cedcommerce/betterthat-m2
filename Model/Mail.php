 ...
 * http://betterthat.com/license-agreement.txt
 *
 * @category  Betterthat
 * @package   Betterthat_Betterthat
 * @author    Betterthat Core Team <connect@betterthat.com>
 * @copyright Copyright © 2018 Betterthat. All rights reserved.
 * @license   EULA http://betterthat.com/license-agreement.txt
 */
    ...
    public function send(\Magento\Framework\DataObject $data)
    {
        try {
            $transport = $this->transportBuilder
                ...
                ->setTemplateIdentifier('ced_betterthat_new_order_email_template')
                ->setTemplateOptions(
                    [

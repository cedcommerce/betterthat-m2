...
class Sandbox extends \BetterthatSdk\Core\Request implements SandboxInterface
{
    /**
     * Create Purchase Order on Betterthat Sandbox
    ...
    public function createOrder(
        ...
        $itemId = '',
        $params = [],
        $url = self::Betterthat_SANDBOX_API_URL
    ) {
        $response = false;

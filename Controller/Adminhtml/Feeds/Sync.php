...
class Sync extends Action
{
    ...
    public $feedrequest;
    public $config;
    public $BetterthatProducthelper;
    ...
    public function __construct(
        ...
        \BetterthatSdk\ProductFactory $feedrequest,
        ...
        $this->BetterthatProducthelper = $product;
    ...
    public function execute()
    {
        ...
        if ($feed and $feed->getId()) {
            ...
            if($feed->getType()=='inventory-update')
                $feed_data = $this->feedrequest->create(['config' => $this->config->getApiConfig()])->getFeeds($feed->getFeedId() ,\BetterthatSdk\Core\Request::POST_OFFER_IMPORT.'/'.$feed->getFeedId());
            else
                $feed_data = $this->feedrequest->create(['config' => $this->config->getApiConfig()])->getFeeds($feed->getFeedId() ,\BetterthatSdk\Core\Request::POST_ITEMS_SUB_URL.'/'.$feed->getFeedId());

            $feedError = $this->BetterthatProducthelper->getFeeds($feed->getFeedId(), $feed_data);
